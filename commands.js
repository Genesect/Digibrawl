 ...
 *
 * These are system commands - commands required for Digibrawl
	...
	avatar: function(target, room, user) {
		...
		if (!parts[1]) {
			this.sendReply("Avatar changed to:\n" +
					'|raw|<img src="//play.digibrawl.com/sprites/tamers/'+avatar+'.png" alt="" width="80" height="80" />');
		}
	},
